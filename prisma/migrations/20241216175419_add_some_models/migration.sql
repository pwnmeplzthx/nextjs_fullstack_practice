/*
  ...
  - Added the required column `price` to the `Resource` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Resource" ADD COLUMN     "price" INTEGER NOT NULL,
ADD COLUMN     "resourceTypeId" INTEGER NOT NULL;
